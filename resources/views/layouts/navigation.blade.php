...
@if(auth()->user()->role === 'admin')
    ...
    <x-nav-link :href="route('titik-risiko.jumlah')" :active="request()->routeIs('titik-risiko.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('titik-risiko.index')" :active="request()->routeIs('titik-risiko.*')">
                    {{ __('Jumlah Titik Risiko') }}
                </x-responsive-nav-link>
